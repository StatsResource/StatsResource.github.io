...
*  The probability of a Type I error is designated by the Greek letter alpha ( $\LARGE \alpha$) and is called the Type I error rate.
*  The probability of a Type II error (the Type II error rate) is designated by the Greek letter beta ( $\LARGE \beta$ ).
...
<p> 
* The probability of a Type I error ( $\LARGE \alpha$ ) is called the significance level and is set by the experimenter. There is a trade-off between Type I and Type II errors. The more an experimenter protects themselves against Type I errors by choosing a low level, the greater the chance of a Type II error.
<p>
...
*  The schedule of formulae that will be at the back of your examination paper will be posted on the SULIS site shortly.
*  It is advisable to familiarize yourself with the contents before the examination.
*  Please let me know as soon as possible if there are any issues with it.
