...
\begin{itemize}
<p>In the case of goodness of fit tests, there is only one
...
<p>The observed frequencies can be listed as a single row, or as a
...
<p>When two variables are involved, the observed frequencies are
entered in a two-way classification table, or contingency table.

<p>The dimensions of such tables are defined by $r \times c$, in
...
<p>Given the hypothesis of independence of the two variables, the
...
<p>Where $fr$ is the total frequency in a given row and $fc$ is the
...
<p>The general formula for the degrees of freedom associated with a
