...
*  The set of all possible outcomes of a probability experiment is called a ***{\emph{sample space}}, which is usually denoted by $\boldsymbol{S}$.
*  The sample space is an exhaustive list of all the possible outcomes of an experiment. We call individual elements of this list ***{\emph{sample points}}.
