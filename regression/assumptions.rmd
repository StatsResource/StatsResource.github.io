  ...
  <body>
    ...
    <div id="main_content_wrap" class="outer">
      <section id="main_content" class="inner">
        <h2> Assumptions for Linear Regression </h2>
...
<col style="width: 300px">
  ...
  <tr>
    <td class="tg-76so"><strong>Financial Maths</strong><br> Seperable Equations</td>
    <td class="tg-76so"><strong><a href="firstorderODEs.html">First Order ODEs</a> </strong><br></td>
    <td class="tg-76so"><strong><a href="secondorderODEs.html">Second Order ODEs</a></strong><br> General Solutions</td>
    </tr>
